                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ $route }}" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div>
                                        <button id="submitBtn" class="btn btn-primary" style="width: 100%" type="submit" onclick="updateAlamatAyah(); updateAlamatIbu(); updateAlamatWali(); updateDateOfBirthAyah(); updateDateOfBirthIbu(); updateDateOfBirthWali();">SIMPAN DATA</button>
                                    </div>
                                </form>
                            </div>
                        </div>
