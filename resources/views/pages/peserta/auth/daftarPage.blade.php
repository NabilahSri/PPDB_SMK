...
<head>
    ...
    <meta charset="utf-8" />
    <title>Daftar - PPDB SMK YPC TASIKMALAYA </title>
                            ...
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h5 class="text-primary mb-2 mt-3">Halaman Daftar !</h5>
                                        <p class="text-muted">Calon Siswa Baru SMK YPC Tasikmalaya.</p>
                                    </div>

                                    <form action="{{ route('daftar.siswa') }}" method="POST" class="form-horizontal mt-4 pt-2">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="confirm_password" class="form-control"
                                                id="userpassword" placeholder="Masukan Konfimasi Password">
                                        </div>
